 ...
 *
 * @author savio
 * @version $Id: RobotImpl.java,v 1.16 2005/07/04 03:36:14 savio Exp $
 */
...
public class RobotImpl extends java.rmi.server.UnicastRemoteObject implements Robot {
   ...
   public boolean getReady() throws RemoteException {
     ...
     * Set Gradient
     *
     * @param rgradient Gradient
     */
    public void setGradient(Gradient rgradient) throws RemoteException {
        gradient = rgradient;
    }
